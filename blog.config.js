...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '76d37d72bf82419287b5cbc3c01e8b9e',
  ...
  CONTACT_EMAIL: 'zhaochenyang20@gmail.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/zhaochenyang20', // 你的github个人主页
  ...
  MUSIC_PLAYER_SHOW_LRC: process.env.NEXT_PUBLIC_MUSIC_PLAYER_SHOW_LRC || true, // 是否展示歌词（前提是有配置歌词路径，对 meting 无效）
  ...
  MUSIC_PLAYER_AUDIO_LIST: [ // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      url: 'https://music.163.com/song/media/outer/url?id=1341060947.mp3',
      cover: 'http://p2.music.126.net/KY8_yIGI24NER1vMgQJ_hg==/109951163806623912.jpg'
    },
    {
      name: '若把你',
      artist: 'Kirsty 刘瑾睿',
    ...
    },
    {
      name: 'Call Me a Fool',
      artist: 'Perlo',
      url: 'https://music.163.com/song/media/outer/url?id=1305174454.mp3',
      cover: 'http://p2.music.126.net/v6EqG2UKhy2QZHiTem1FyQ==/109951166465359873.jpg'
    }
  ],
  ...
  MUSIC_PLAYER_METING_ID: process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '749774921', // 对应歌单的 id
  ...
  VERSION: process.env.NEXT_PUBLIC_VERSION // 版本号 e417b3802ef74df0973fea3ad1a557ce
}
